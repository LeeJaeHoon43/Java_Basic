public class HashcodeEx{
	public static void main(String[] args){
		...
		System.out.println("test1과 test2의 해시코드는 같나요 ? : " + (test1.hashCode() == test2.hashCode()));
		System.out.println("test1의 해시코드 ? : " + test1.hashCode());
		System.out.println("test2의 해시코드 ? : " + test2.hashCode());
	}
}